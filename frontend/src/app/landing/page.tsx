    ...
    <div className="min-h-screen ">
      <header className="bg-white shadow-md sticky top-0 z-50">
        <nav className="container mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            <div className="text-xl font-bold text-green-600">EcoCoin Rewards</div>
      ...
      <main className=" py-8">
        <section className="container mx-auto text-center mb-16 h-screen flex flex-col justify-center items-center px-6">
          ...
          <Link href="/" className="bg-green-500 rounded-full text-white px-6 py-3 text-lg font-semibold hover:bg-green-600 transition duration-300">
