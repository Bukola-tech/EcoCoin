    ...
    <div className="min-h-screen ">
      <header className="bg-white shadow-md sticky top-0 z-50">
        <nav className="container mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            <Image src="/images/ecoCoinLogo.jpeg" alt="EcoCoin Logo" width={150} height={150} />
            <div className="hidden md:flex space-x-4">
              <a href="#how-it-works" className="text-gray-600 hover:text-green-500">How It Works</a>
              <a href="#benefits" className="text-gray-600 hover:text-green-500">Benefits</a>
              <a href="#levels" className="text-gray-600 hover:text-green-500">Level Up</a>
              <a href="#claim" className="text-gray-600 hover:text-green-500">Claim Rewards</a>
            </div>
          </div>
        </nav>
      </header>
      ...
      <main className=" py-8">
        <section className="container mx-auto text-center mb-16 h-screen flex flex-col justify-center items-center px-6">
          <h1 className="text-4xl md:text-8xl font-bold text-gray-800 mb-4">
            Turn Plastic into Prosperity
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Claim your EcoCoin rewards, level up, and amplify your impact. The more you recycle, the more you earn!
          </p>
          <Link href="/user" className="bg-green-500 rounded-full text-white px-6 py-3 text-lg font-semibold hover:bg-green-600 transition duration-300">
        ...
        <section id="how-it-works" className="-mt-[100px] bg-green-200 py-20">
        <div className='container mx-auto'>
          <h2 className="text-3xl font-bold text-green-500 mb-4">Turning Trash into Treasure</h2>
          <p className="text-gray-600">
            At EcoCoin, we've gamified recycling. Collect plastic waste, bring it to our collection points, 
            and watch as it transforms into valuable EcoCoin tokens. Each collection is minted as a unique NFT, 
            proving your impact and earning you rewards. But that's not all – consistently great performance 
            unlocks new levels, multiplying your earning potential. It's not just about cleaning up; it's about 
            growing your impact and rewards over time.
          </p>
        </div>
        </section>

        <section id="benefits" className="pb-16 bg-green-200">
        <div className='container mx-auto'>
        ...
        <section id="levels" className="my-16 container mx-auto">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Level Up, Earn More</h2>
          <p className="text-gray-600 mb-6">
            Your commitment to cleaning our planet doesn't go unnoticed. Our level system rewards consistent action:
          </p>
        ...
        <section id="claim" className="text-center container mx-auto">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Ready to Claim Your Impact?</h2>
          <p className="text-gray-600 mb-8">
            You've done the hard work of collecting plastic and leveling up. Now it's time to reap the rewards. 
            Connect your wallet, verify your collections, and watch your CauseKoin balance grow. Every token and 
            level-up is a testament to your commitment to a cleaner Earth.
          </p>
